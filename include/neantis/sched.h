...
struct i387_struct
{
    ...
    long foo;
    long fos;
    long st_space[20]; // 2 bytes per st : st0-st9
};
...
struct task_struct
{
    ...
    long priority;
    long signal;
    struct sigaction signaction[32];
    long blocked;
